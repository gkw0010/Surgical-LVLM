...
from models.GatedLanguageVisualEmbedding_MUTAN import VisualBertEmbeddings
from utils import *
...
'''
class LViTPrediction_MUTAN(nn.Module):
    '''
    VisualBert Classification Model
    ...
    def __init__(self, vocab_size, layers, n_heads, num_class):
        super(LViTPrediction_MUTAN, self).__init__()
