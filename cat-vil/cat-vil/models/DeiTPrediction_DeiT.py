...
from models.CATViLEmbedding_DeiT import VisualBertEmbeddings
from utils import *

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

class DeiTPrediction_DeiT(nn.Module):
    '''
    ...
    def __init__(self, vocab_size, layers, n_heads, num_class):
        super(DeiTPrediction_DeiT, self).__init__()
        ...
        # self.mcan_layer = MLP(768, 768, 768, 2)
        # self.mcan_norm = nn.LayerNorm(768)
    ...
    def forward(self, inputs, visual_embeds):
        ...
        # outputs = self.mcan_layer(embedding_output)
        # outputs = self.mcan_norm(outputs)
